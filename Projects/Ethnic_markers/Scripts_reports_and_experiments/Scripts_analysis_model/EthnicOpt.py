...
for i in range(0,Ng):
    ...
    plt.plot(tempo,Traxec[4*i],label='Circles,0')
    plt.plot(tempo,Traxec[4*i+1],label='Circles 1')
    plt.plot(tempo,Traxec[4*i+2],label='Triangles 0')
    plt.plot(tempo,Traxec[4*i+3],label='Triangles 1')
    plt.title('Grupo'+str(i+1)+','+'N='+str(N))
    plt.xlabel('Time')
    plt.ylabel('Agents')
    plt.legend()
    fig.savefig('EM1Group'+str(i+1)+'a='+str(alpha)+'d='+str(delta)
    +'e='+str(e)+'r='+str(r)+'m='+str(m)+'.jpg')
    
for i in range(0,Ng):
    fig=plt.figure(figsize=(10,8))
    plt.plot(tempo,Paytemp[4*i],label='Circles 0')
    plt.plot(tempo,Paytemp[4*i+1],label='Circles 1')
    plt.plot(tempo,Paytemp[4*i+2],label='Triangles 0')
    plt.plot(tempo,Paytemp[4*i+3],label='Triangles 1')
    plt.title('Grupo'+str(i+1)+','+'N='+str(N))
    plt.xlabel('Time')
    plt.ylabel('Payoff') 
    plt.legend()
    fig.savefig('EM1Payoff'+str(i+1)+'a='+str(alpha)+'d='+str(delta)
    +'e='+str(e)+'r='+str(r)+'m='+str(m)+'.jpg')
