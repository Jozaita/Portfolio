...
open(unit=13,file='NVMantiag23.txt',action='write')
...
do a2=20,20+apasos
	...
	open(unit=13,file='NVMantiag23.txt',status='old',position='append',action='write')
	write(13,'(7e13.6)')a,xm,xm2,xm4,taumaj,taumin,taudif	
	close(unit=13)	
