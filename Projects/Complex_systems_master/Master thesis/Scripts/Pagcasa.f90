...
call dran_ini(5000)
open(unit=66,file='PagL322casa1p1.txt',status='old',action='write')
...
do rho2=5,5
	...
	open(unit=66,file='PagL322casa1p1.txt',status='old',position='append',action='write')
	write(66,'(8f13.6)')a,dble(rho)/dble(N),m,m2,m4,taumaj,taumin,taumaj-taumin
