...
call dran_ini(5000)
open(unit=44,file='Pruebe5.txt',status='replace',action='write')
...
do rho2=1,10,1
	...
	open(unit=44,file='Pruebe5.txt',status='old',position='append',action='write')
	write(44,'(8f13.6)')a,rho,m,m2,m4,taumaj,taumin,taumaj-taumin
