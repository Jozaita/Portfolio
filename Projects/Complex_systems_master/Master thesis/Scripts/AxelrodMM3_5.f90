...
integer::iran_poisson,vec,m,ma,p2,front
integer,dimension(N,F)::atr
...
call dran_ini(5000)
open(unit=40,file='AxelrodMM3p305.txt',status='replace',action='write')
...
write(40,'(5f13.6)')rho,tmaxprom,tmaxvar,lmaxprom,lmaxvar
write(*,*)rho,tmaxprom,tmaxvar,lmaxprom,lmaxvar,finish-start
deallocate(chosen)
!write(*,*)rho,q,lmaxvar,tmaxvar2

end do
end program AxelrodMM3_2
