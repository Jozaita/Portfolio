...
call cpu_time(start)
call dran_ini(5000)
open(unit=44,file='PagL325.txt',status='replace',action='write')
...
do rho2=5,5
	...
	open(unit=44,file='PagL325.txt',status='old',position='append',action='write')
	write(44,'(8f13.6)')a,dble(rho)/dble(N),m,m2,m4,taumaj,taumin,taumaj-taumin
	close(unit=44)
