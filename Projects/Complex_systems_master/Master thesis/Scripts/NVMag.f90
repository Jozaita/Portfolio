...
integer(dp)::tray,i,j,cont,apasos,a2
real(dp)::n,r,xm,xm2,xm4,x,q,m,taumaj,taumin,a,iprom,ivar
...
open(unit=15,file='NVMag2.txt',status='replace',action='write')
...
do a2=1,apasos
	...
	write(15,'(7e13.6)')a,xm,xm2,xm4,taumaj,taumin,taumaj-taumin
	write(*,*)a,xm,xm2,xm4,taumaj,taumin,taumaj-taumin
end do
close(unit=20)	
end program	
