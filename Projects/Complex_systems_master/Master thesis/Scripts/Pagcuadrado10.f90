...
call cpu_time(start)
call dran_ini(5000)
open(unit=49,file='PagL3210.txt',status='replace',action='write')
...
do rho2=10,10
	...
	open(unit=49,file='PagL3210.txt',status='old',position='append',action='write')
	write(49,'(8f13.6)')a,dble(rho)/dble(N),m,m2,m4,taumaj,taumin,taumaj-taumin
	close(unit=49)
