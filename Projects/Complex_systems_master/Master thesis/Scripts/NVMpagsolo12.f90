...
open(unit=82,file='NVMpag032.txt',status='new',action='write')
 close(unit=82)
	
apasos=20
do a2=1,10
a=dble(a2)*2.5d0*10.0d0**(-3.0d0)+7.5d0*10.0d0**(-2.0d0)
	...
	call cpu_time(finish)
	open(unit=82,file='NVMpag032.txt',status='old',position='append',action='write')
	write(82,'(8e13.6)')a,rho,xm,xm2,xm4,taumaj,taumin,taumaj-taumin
	close(unit=82)
