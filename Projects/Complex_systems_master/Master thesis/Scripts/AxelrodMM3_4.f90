...
integer,dimension(4)::neigh
real(dp)::start,dens,finish,act,tmaxprom,b,dran_u,mu,tmaxvar,lmaxprom,lmaxvar
real(dp),dimension(100)::smax 

call dran_ini(5000)
open(unit=20,file='AxelrodMM1q25.txt',status='replace',action='write')
...
write(*,*)b,finish-start
write(*,*)tmaxprom,tmaxvar,lmaxprom,lmaxvar
write(20,'(5f13.6)')b,tmaxprom,tmaxvar,lmaxprom,lmaxvar
deallocate(freq)
end do
call cpu_time(finish)
write(*,*)finish-start

end program AxelrodMM3_4
