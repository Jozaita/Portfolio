...
real(dp),parameter::Num=1000.0d0 , a=10.0d0**(-4.0d0)
...
do tray=1,sim
	...
	!Fin M1
		...
		taun=0.0d0
		do i=1,long
			omega1(i)=nip(i)*(a/2.0d0+(1.0d0-a)/(2.0d0+dble(i-1))*(1.0d0+dble(i-1))*(n/Num))
			omega2(i)=nin(i)*(a/2.0d0+(1.0d0-a)/(2.0d0+dble(i-1))*(1.0d0+dble(i-1))*(m/Num))
			omega3(i)=nip(i)*(a/2.0d0+(1.0d0-a)/(2.0d0+dble(i-1))*((m/Num)*(dble(i-1)+1.0d0)+1.0d0))
			omega4(i)=nin(i)*(a/2.0d0+(1.0d0-a)/(2.0d0+dble(i-1))*((n/Num)*(dble(i-1)+1.0d0)+1.0d0))
...
open(unit=50,file='NVM2ag.txt',status='replace',action='write')
open(unit=70,file='NVM2ag2.txt',status='replace',action='write')
