...
call dran_ini(5000)
open(unit=46,file='Pruebe7.txt',status='replace',action='write')
...
do rho2=1,10,1
	...
	open(unit=46,file='Pruebe7.txt',status='old',position='append',action='write')
	write(46,'(8f13.6)')a,rho,m,m2,m4,taumaj,taumin,taumaj-taumin
