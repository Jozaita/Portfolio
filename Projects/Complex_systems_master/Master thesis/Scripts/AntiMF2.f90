...
open(unit=12,file='NVMantiag22.txt',action='write')
...
do a2=10,10+apasos
	...
	open(unit=12,file='NVMantiag22.txt',status='old',position='append',action='write')
	write(12,'(7e13.6)')a,xm,xm2,xm4,taumaj,taumin,taudif	
	close(unit=12)	
