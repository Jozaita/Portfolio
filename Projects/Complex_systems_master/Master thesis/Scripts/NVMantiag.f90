...
real(dp),parameter::Num=2000.0d0 
integer,parameter:: long=100
integer(dp),parameter::sim=int(Num)
...
open(unit=10,file='NVMantiagn2000.txt',action='write')
...
do a2=1,apasos
	...
	write(10,'(7e13.6)')a,xm,xm2,xm4,taumaj,taumin,taudif	
