...
call dran_ini(5000)
open(unit=43,file='Pruebe4.txt',status='replace',action='write')
...
do rho2=1,10,1
	...
	open(unit=43,file='Pruebe4.txt',status='old',position='append',action='write')
	write(43,'(8f13.6)')a,rho,m,m2,m4,taumaj,taumin,taumaj-taumin
