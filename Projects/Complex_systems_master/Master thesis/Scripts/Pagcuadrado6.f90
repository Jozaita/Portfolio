...
call cpu_time(start)
call dran_ini(5000)
open(unit=45,file='PagL326.txt',status='replace',action='write')
...
do rho2=6,6
	...
	open(unit=45,file='PagL326.txt',status='old',position='append',action='write')
	write(45,'(8f13.6)')a,dble(rho)/dble(N),m,m2,m4,taumaj,taumin,taumaj-taumin
	close(unit=45)
