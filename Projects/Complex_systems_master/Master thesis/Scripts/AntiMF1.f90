...
open(unit=11,file='NVMantiag21.txt',action='write')
...
do a2=1,apasos
	...
	open(unit=11,file='NVMantiag21.txt',status='old',position='append',action='write')
	write(11,'(7e13.6)')a,xm,xm2,xm4,taumaj,taumin,taudif	
	close(unit=11)
