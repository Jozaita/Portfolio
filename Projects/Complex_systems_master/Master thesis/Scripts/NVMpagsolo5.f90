...
real(dp),parameter::Num=2000.0d0,rho=0.20d0
...
open(unit=75,file='NVMpag025.txt',status='new',action='write')
 close(unit=75)
...
a=dble(a2)*2.5d0*10.0d0**(-3.0d0)
	...
	call cpu_time(finish)
	open(unit=75,file='NVMpag025.txt',status='old',position='append',action='write')
