...
open(unit=73,file='NVMpags3.txt',status='new',action='write')
 close(unit=73)
...
do rho2=1,10
	...
	call cpu_time(finish)
	open(unit=73,file='NVMpags3.txt',status='old',position='append',action='write')
	write(73,'(8e13.6)')a,rho,xm,xm2,xm4,taumaj,taumin,taumaj-taumin
	close(unit=73)
