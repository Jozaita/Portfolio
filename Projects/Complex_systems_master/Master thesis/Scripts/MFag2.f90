...
integer,parameter:: N=2500,sim=N
...
call dran_ini(5000)
open(unit=41,file='Pruebu4_1.txt',status='replace',action='write')
...
do rho2=0,0
	...
	open(unit=41,file='Pruebu4_1.txt',status='old',position='append',action='write')
	write(41,'(8f13.6)')a,rho,m,m2,m4,taumaj,taumin,taumaj-taumin
