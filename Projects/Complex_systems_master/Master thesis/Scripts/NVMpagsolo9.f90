...
open(unit=79,file='NVMpag029.txt',status='new',action='write')
 close(unit=79)
	
apasos=20
do a2=1,10
a=dble(a2)*2.5d0*10.0d0**(-3.0d0)
	...
	call cpu_time(finish)
	open(unit=79,file='NVMpag029.txt',status='old',position='append',action='write')
