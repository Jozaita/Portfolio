...
call dran_ini(5000)
open(unit=71,file='Pruebee4_6.txt',status='replace',action='write')
...
do rho2=0,0
	...
	open(unit=71,file='Pruebee4_6.txt',status='old',position='append',action='write')
	write(71,'(8f13.6)')a,dble(rho)/dble(N),m,m2,m4,taumaj,taumin,taumaj-taumin
